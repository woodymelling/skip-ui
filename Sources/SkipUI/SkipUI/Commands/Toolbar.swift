...
extension View {
    ...
    public func toolbarTitleMenu<Content: View>(@ViewBuilder content: () -> Content) -> some View {
        #if SKIP
    ...
    // SKIP @bridge
    public func toolbarTitleMenu(id: String, bridgedContent: any View) -> any View {
        #if SKIP
        return preference(key: ToolbarContentPreferenceKey.self, value: ToolbarContentPreferences(titleMenu: ComposeBuilder.from { bridgedContent }))
        #else
        return self
        #endif
    }
